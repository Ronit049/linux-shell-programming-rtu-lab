...
Rajasthan Technical University (RTU) syllabus.
...
linux-shell-programming-rtu-lab
│
├── program1-system-info.sh
├── program2-file-check.sh
├── program3-arithmetic.sh
├── program4-largest-number.sh
├── program5-even-odd.sh
├── program6-for-loop.sh
├── program7-while-loop.sh
├── program8-table.sh
├── program9-count-files.sh
├── program10-menu-program.sh
│
